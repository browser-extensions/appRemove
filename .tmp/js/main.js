...
var PLElements = {
    ...
    "yixun.com": ".goods_buy",
    "taobao.com": ".bottom_bar,.item-action,.J_bottomBar,.install-app,.thw-smartbanner,.openapp,.download-adv,#J_JHSDownloadBar,#J_JHSDownloadMask,.thw-promotion-app,.thw-smartbanner,.thw-detail-panel",
